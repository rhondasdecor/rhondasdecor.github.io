...
//radio	
 ...
 butcancel.innerHTML = ('Cancel');
  ...
  butok.innerHTML = ('OK');
  butok.style.margin = '10px';
   butok.style.color = 'red';
...
var mydia = document.getElementById("mydia");
...
var ele = document.getElementsByName('radiogroup');
            ...
            for(i = 0; i < ele.length; i++) {
                if(ele[i].checked){
					 selectedoption  = (labels[i].innerText);
...
openexistingevent2(); //populate mydia1 with arraylocalevents
...
mydia = document.getElementById("mydia1");
 ...
 var i = 0;
arraylocalevents.forEach (myarrayfunction1);
function myarrayfunction1(value){
//radio	
  //<input type="radio" id="male" name="gender" value="male">
  //<label for="male">Male</label><br>
  var labelvar = document.createElement("label");
   labelvar.setAttribute("id", "label"+i);
   labelvar.setAttribute("name", "labelgroup1");
   var inputvar = document.createElement("input");
   inputvar.setAttribute("type", "radio");
   inputvar.setAttribute("id", "radio"+i);
   inputvar.setAttribute("name", "radiogroup1");
...
var mydia = document.getElementById("mydia1");
...
var labels = document.getElementsByName('labelgroup1');
...
var ele = document.getElementsByName('radiogroup1');
            ...
            for(i = 0; i < ele.length; i++) {
                ...
                if(ele[i].checked){
					selectedoption1  = (labels[i].innerText);
					var myNode = document.getElementById("mydia1");
  openeventselected1(selectedoption1); //populate form with selected EVENT data
					return;
				            //  console.log ("Selected Option: "+labels[i].innerText);
							}
							              }
	if (selectedoption1=='');{
	alert('You did not select an Existing Event');	
	}
...
var namestrparsedstr = ''; 
 ...
 function openeventselected1(selectedoption1){
	 ...
	 //this saves the new event form data
		...
		var name = selectedoption1;
		 namestr = "EVENT"+name+"str";	


//this save ori name of this Event to localstorage as namestrnameori
	namestrnameori = namestr+name 
	 localStorage.setItem(namestrnameori, namestr);
namestrnameori = localStorage.getItem(namestrnameori);
...
function savenewevent() {
	...
	//this checks for any name change
